...
@section('content')
  <section class="review mx-auto">
    <h2 class="text-text text-2xl font-semibold">Edit Review</h2>
      ...
      <div class="card w-full rounded-md p-4">
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div class="mb-6">
            ...
            <select class="block w-full rounded-md border border-gray-500 bg-transparent text-sm" id="movie" name="movie_id">
              ...
              @foreach ($movies as $movie)
                <option value="{{ $movie->id }}" @selected(old('movie_id', $review->movie_id) == $movie->id)>{{ $movie->judul }}</option>
              @endforeach
            </select>
          ...
          <div class="mb-6">
            ...
            <div x-data="{ rating: {{ $review->rating }}, hover: 0 }">
          ...
          <div class="mb-6">
            ...
            <textarea class="block w-full rounded-md border border-gray-500 bg-transparent text-sm" id="review" name="review_text" cols="30" rows="10">{{ old('review_text', $review->review_text) }}</textarea>
