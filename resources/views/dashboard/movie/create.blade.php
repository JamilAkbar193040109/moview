...
@section('title', 'Create Data Film')
@section('content')
  <section class="movies">
    <div class="mb-4 flex items-center justify-between">
      <h2 class="text-2xl font-semibold">Tambah Data Film</h2>
    ...
    <div class="card w-full rounded-md p-4 md:w-1/2">
      <form action="{{ route('dashboard.movies.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-6">
          ...
          <textarea class="block w-full rounded-md border border-gray-500 bg-transparent text-sm" id="sinopsis" name="sinopsis" cols="30" rows="10"></textarea>
